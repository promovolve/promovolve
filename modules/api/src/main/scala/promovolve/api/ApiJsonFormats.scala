...
trait ApiJsonFormats extends DefaultJsonProtocol {
  ...
  given RootJsonFormat[AdvertiserReportBreakdownByCampaignResponse] = jsonFormat5(AdvertiserReportBreakdownByCampaignResponse.apply)
  given RootJsonFormat[ReportBreakdownDailyRow]    = jsonFormat8(ReportBreakdownDailyRow.apply)
  given RootJsonFormat[AdvertiserReportBreakdownDailyResponse] = jsonFormat5(AdvertiserReportBreakdownDailyResponse.apply)
  given RootJsonFormat[PublisherSiteCategoryDailyRow] = jsonFormat9(PublisherSiteCategoryDailyRow.apply)
  given RootJsonFormat[PublisherSiteCategoryDailyReportResponse] = jsonFormat4(PublisherSiteCategoryDailyReportResponse.apply)
