...
object ApiSchemas {
  ...
  given Schema[MarketRateRow] = Schema.derived
  ...
  given Schema[FraudSuspectCount] = Schema.derived
  given Schema[FraudSuspectSummary] = Schema.derived
  ...
  given Schema[TrustAnchorDetail] = Schema.derived
