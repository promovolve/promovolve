...
class SlotPriorSpec extends AnyWordSpec with Matchers {
  ...
  private val hdr      = SlotPrior.computeQualityScore(aboveFold = true,  initialViewability = 1.00, region = "header",  textDensity = 0.73)
  private val article  = SlotPrior.computeQualityScore(aboveFold = true,  initialViewability = 1.00, region = "article", textDensity = 0.71)
  private val sidebar  = SlotPrior.computeQualityScore(aboveFold = true,  initialViewability = 0.88, region = "aside",   textDensity = 0.71)
  private val footer   = SlotPrior.computeQualityScore(aboveFold = false, initialViewability = 0.00, region = "footer",  textDensity = 0.73)
