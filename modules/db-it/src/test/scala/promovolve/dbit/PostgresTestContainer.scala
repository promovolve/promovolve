...
object PostgresTestContainer {
  ...
  def username: String = sys.env.getOrElse("DB_IT_DATABASE_USER", externalUrl.fold(container.getUsername)(_ => "promovolve"))
  def password: String = sys.env.getOrElse("DB_IT_DATABASE_PASSWORD", externalUrl.fold(container.getPassword)(_ => "promovolve"))
