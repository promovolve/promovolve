...
func TestI18nSweptPagesRenderBothLangs(t *testing.T) {
	...
	cases := []struct {
		...
		{"publisher/approval.html", pageData{Title: "Approval", User: user}},
		{"admin/requests.html", pageData{Title: "Account Requests", User: user}},
		{"admin/sites.html", pageData{Title: "Site Requests", User: user}},
		{"admin/settings.html", pageData{Title: "Platform Settings", User: user}},
		{"org/members.html", pageData{Title: "Team", User: user,
			OrgPage: &orgPageData{Domain: "example.com", Name: "Example", MaxMembers: 5, MissingSide: "publisher"}}},
		{"account-passkeys.html", pageData{Title: "Your passkeys", User: user}},
		{"advertiser/creative-editor.html", pageData{Title: "Creative Editor", User: user}},
